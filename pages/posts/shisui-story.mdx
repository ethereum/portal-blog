...
author: Grapebaba & Dr. Zhou Qi
---

# What is shisui
[Shisui](https://github.com/optimism-java/shisui) is an Ethereum portal client written in Go language.
...
At the same time, Dr. Zhou Qi from EthStorage wanted to use the portal client in their web3:// protocol. They were also interested in implementing the portal client in the Go language, so we joined forces.
...
In January this year, Dr. Zhou Qi expressed his commitment to giving us a small grant of 5,000 USD.
Since then, we have established weekly meetings and formulated the first milestone, hoping to pass the hive history interop tests in February or March.
I am very happy that when writing this blog, we have completely passed all these tests with trin and fluffy.
...
Though we passed the hive history interop tests, we still have a lot of development work to do.
